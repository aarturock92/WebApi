    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CEMEX.Data.CemexContext>
    {
        ...
        private Menu[] GetMenus()
        {
            return new Menu[]
            {
                ...
                new Menu() { IdMenuPadre = 2, Nombre = "Administración de Perfiles", Descripcion = "Administración de Perfiles", Url ="AdmonPerfiles.aspx", Orden = 1, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                new Menu() { IdMenuPadre = 2, Nombre = "Administración de Usuarios", Descripcion = "Administración de Usuarios", Url ="/usuario", Orden = 2, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                new Menu() { IdMenuPadre = 2, Nombre = "Administración de Móviles", Descripcion = "Administración de Móviles", Url ="/movil", Orden = 3, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                new Menu() { IdMenuPadre = 2, Nombre = "Catálogos", Descripcion = "Catálogos", Url ="AdmonCatalogos.aspx", Orden = 4, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                new Menu() { IdMenuPadre = 2, Nombre = "Carga Masiva", Descripcion = "Carga Masiva", Url ="CargaMasiva.aspx", Orden = 5, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                ...
                new Menu() { IdMenuPadre = 8, Nombre = "Administración de Encuestas", Descripcion = "Administración de Encuestas", Url ="AdmonEncuestas.aspx", Orden = 1, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                new Menu() { IdMenuPadre = 8, Nombre = "Administración de Secciones", Descripcion = "Administración de Secciones", Url ="AdmonSecciones.aspx", Orden = 2, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
                ...
                new Menu() { IdMenuPadre = 11, Nombre = "Administración de Rutas", Descripcion = "Administración de Rutas", Url ="AdmonRutas.aspx", Orden =1, CssClass ="", IdEstatus = 1, FechaAlta = DateTime.Now, FechaModifico = DateTime.Now, IdUsuarioAlta = 0, IdUsuarioModifico = 0 },
